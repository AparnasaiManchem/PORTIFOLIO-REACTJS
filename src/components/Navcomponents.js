                ...
                <div className="row justify-content-center bg-info">
                    <div className="col-lg-10" id="back">
                        ...
                        <div className="text-center text-light" id="back-text">
                            <h1>Hi! There, Manchem Aparna Sai</h1>
            ...
            <div class="container-lg">
                <div class="row justify-content-center align-item-center">
                    <div class="col-md-5 text-center text-md-start border border-secondary" style={{ backgroundColor: "rgb(214, 213, 213)" }}>
                        <h1>
                            <div class="display-4">Manchem Aparna Sai</div>
                        ...
                        <div class="contact">
                            ...
                            <span class="lead"><i class="bi bi-envelope-at-fill"></i> How to reach me :
                                <a href="mailto:aparnasaimanchem.com" class="btn btn-sm btn-primary fw-bold">Email</a>
                            </span>
                            <br /><br />
                            <span class="lead"><i class="bi bi-geo-fill"></i> Eluru, Andra Pradesh</span>
                            <br /><br />
                            <span class="lead fw-900"><i class="bi bi-at"></i> Connect with me : </span>
                            <p class="btn-group">
                                <a href="https://www.linkedin.com/in/aparna-sai-manchem-1b402525b/" target="_blank" class="btn btn-sm btn-success fw-bold"><i class="bi bi-linkedin"></i> Linked In</a>
                                <a href="https://github.com/AparnasaiManchem" target="_blank" class="btn btn-warning btn-sm fw-bold"><i class="bi bi-github"></i> GitHub</a>
                                <a href="https://github.com/AparnasaiManchem" target="_blank" class="btn btn-sm btn-danger fw-bold">LeetCode</a>
                            </p>
                    ...
                    <div class="col-md-5 text-center d-none d-md-block">
                        <span class="tt" data-bs-placement="bottom" title="Manchem Aparna Sai">
                    ...
                    <div class="col-8 col-lg-4 col-xl-3">
                        <div class="card border-info border-2">
                            ...
                            <div class="card-body text-center py-4">
                                ...
                                <a href="https://github.com/AparnasaiManchem?tab=repositories" class="btn btn-outline-danger btn-md mt-3" target="_blank">View</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="list-group">
                            <div class="list-group-item py-3">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="https://github.com/AparnasaiManchem?tab=repositories" target="_blank" class="btn btn-outline-success active">View the Code</a>
                                </div>
                            </div>
                            ...
                            <div class="list-group-item py-3">
                                ...
                                <div class="d-flex justify-content-between">
                                    <small>Difficulty : Easy</small>
                                    <a href="https://github.com/AparnasaiManchem?tab=repositories">View the Code</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <form action="">
                            ...
                            <div class="mb-4 input-group">
                                ...
                                <input type="text" class="form-control" id="name" placeholder="e.g. Manchem Aparna Sai" required />
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="project-1" class="accordion-collapse collpase show" aria-labelledby="heading-1" data-bs-parent="#projects_list">
                                    <div class="accordion-body">
                                        ...
                                        <a href="https://github.com/AparnasaiManchem?tab=repositories" class="btn btn-outline-danger me-2" >App</a>
                                        <a href="https://github.com/AparnasaiManchem?tab=repositories" target="_blank" class="btn btn-outline-danger" >Code</a>
                                    </div>
                                </div>
                            </div>
